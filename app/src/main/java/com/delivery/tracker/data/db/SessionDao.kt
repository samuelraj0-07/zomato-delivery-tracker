...
interface SessionDao {
    ...
    /** Returns list of day-start epoch millis for all sessions in the given month range.
     *  Used by the monthly calendar to highlight ride days. */
    @Query("SELECT dateMillis FROM daily_sessions WHERE dateMillis BETWEEN :startMillis AND :endMillis")
    suspend fun getSessionDateMillisInRange(startMillis: Long, endMillis: Long): List<Long>
